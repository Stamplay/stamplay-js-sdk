...
suite('Codeblock', function () {
  ...
  setup('Creating a new Codeblock', function () {
    ...
    codeblock = new Stamplay.Codeblock('myCodeblock');
  ...
  test('has the url property', function () {
    assert.isString(codeblock.url, 'url string exists');
    assert.equal(codeblock.url, '/api/codeblock/' + Stamplay.VERSION + '/run/mycodeblock');
  });

  /** POST **/
  suite('POST', function () {
    test('that run method without arguments make POST api call without body nor query params', function (done) {
    ...
    test('that run method with body make POST api call with body and without query params', function (done) {
      var body = {
        b1: 1,
        b2: 2
      }
    ...
    test('that run method with body make POST api call with body and with query params', function (done) {
      var body = {
        b1: 1,
        b2: 2
      }
